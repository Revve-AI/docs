...
- **OAuth redirect** (Calendly) — you'll be redirected to log in, approve permissions, and return to Revve automatically. See [Connecting Calendly](/integrations/connecting-calendly).
...
| **CRM** | HubSpot, Salesforce, Outreach, ActiveCampaign | Sync call and chat results and leads to your CRM. CRM apps also appear as read-only "managed" actions in [automation rules](/automations/automation-rules-overview). |
