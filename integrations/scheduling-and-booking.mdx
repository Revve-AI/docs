...
| **HubSpot** | Meetings booking via the HubSpot CRM app | [Connecting HubSpot CRM](/integrations/connecting-hubspot-crm) covers the Meeting Configuration card that powers this |
...
![The Schedule Meeting tab in a chat agent's Advanced Settings, with the enable toggle and the Calendar App selector](/screenshots/chatbot-schedule-meeting.png)
