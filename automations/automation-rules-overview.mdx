...
You may also see **managed** actions on some rules — [Salesforce](/integrations/connecting-salesforce)/[HubSpot](/integrations/connecting-hubspot-crm) sync actions like **Save Call Result**, **Save Chat Result**, **Save Lead**, and **Save Campaign Member**. These appear read-only with a "managed" badge: they're provisioned by the CRM app's settings, not addable from the action menu.
