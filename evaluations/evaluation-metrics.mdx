...
|----------|----------------|------|
| Voice Agent **Evaluation** tab | Attach one or more **Scorecards** to a Voice Agent for automatic post-call grading — every completed call is scored against each attached scorecard. | [Voice Agent Evaluation](/voice-agents/voice-agent-evaluation) |
...
| **Scorecards** | The reusable weighted-metrics policy itself — attach it to a Voice Agent for live grading, or run it against a batch of uploaded recordings for retrospective QA. | [Scorecards](/evaluations/scorecards) |
