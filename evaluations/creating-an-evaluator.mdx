...
If your team has no Profiles yet, go to **Evaluations > Profiles** and click **New profile** before returning to finish the evaluator. Profile creation isn't covered further here — this section is only a prerequisite call-out.
