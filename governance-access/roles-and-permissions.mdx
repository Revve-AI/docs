...
2. Each role holds a subset of the permission catalog — anyone with the **Manage Settings** permission can create additional custom roles with any name and any combination of permissions.
...
| **member** | **Manage Dashboard**, **Manage Inbox**, **Manage Tickets**, **Manage Campaigns**, **Manage Agents**, **Manage Contacts**, **Manage History**, **Manage Automations**, and **Manage Analytics**. |

These are the current defaults for newly provisioned teams. Existing teams can have different grants; check **Settings → Roles** for your workspace. The default **member** role includes analytics and automations, but excludes **Manage Settings**, **View PII**, **Publish Agents**, **Publish Campaigns**, **Publish Dashboards**, **View Own Calls**, **Review Call Quality**, and **Manage Call Quality**. An administrator can grant additional permissions through a custom role.
...
Every role — default or custom — is defined as some subset of this catalog.
...
| **Publish Dashboards** | Publishing custom dashboard drafts and reviewing publication requests. |
| **View Own Calls** | Access to the agent's own calls in Call Quality. |
| **Review Call Quality** | Reviewing and scoring calls in Call Quality. |
| **Manage Call Quality** | Assigning quality reviews, reopening submitted reviews, and reading QA reports. |
...
Any member holding **Manage Settings** can create a role with an arbitrary name, description, and any combination of the permissions above.
