...
| **Live Observability** | Off | Allows team members to watch, listen to, and take over this agent's calls from the [Live Calls board](/inbox/live-calls-board). Off by default — if this agent's calls aren't appearing on the board, check this toggle first. Turn it on for agents your team actively supervises in real time; leave it off for agents where live monitoring isn't needed. |
