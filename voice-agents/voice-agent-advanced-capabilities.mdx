...
| **Live Observability** | Off | Lets team members watch, listen to, and take over this agent's calls from the [Live Calls board](/voice-agents/live-calls-board). Turn it on for agents a supervisor needs to monitor in real time — a new campaign, a high-stakes flow, an agent still being tuned. Leave it off for agents that don't need a human safety net once they're stable. |
