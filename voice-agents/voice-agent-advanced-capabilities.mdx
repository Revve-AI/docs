...
| **Live Observability** | Off | Allow team members to watch, listen to, and take over this agent's calls from the [Live Calls board](/voice-agents/live-calls-board). With it off, this agent's calls never appear on the board — there's no way to observe them. Turn it on for agents your team wants to QA or coach in real time. |
