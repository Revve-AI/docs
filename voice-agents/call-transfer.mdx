...
- [Live Calls Board](/voice-agents/live-calls-board) — a different mechanism: a supervisor listening in on or taking over a live call from outside the transfer flow, not the agent handing off.
