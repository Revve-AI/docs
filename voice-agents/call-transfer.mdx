...
|------|-----------|----------------|
| **Bridge Transfer** (default) | SIP INVITE — the human joins the call. The AI goes silent but keeps logging. | You want the full conversation recorded and analyzed end to end. For phone-number transfers, also pick the **Outbound Phone Number** used to dial the human into the call. |
