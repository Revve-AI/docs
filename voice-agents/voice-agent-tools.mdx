...
![The "Create Built-in Validate Tool" dialog, configured with Tool Name "ValidateAccountNumber", a description, Regex Pattern `\d{9}|\d{12}`, a Failure Message, and a Success Message](/screenshots/voice-tool-built-in-validate-configured.png)
