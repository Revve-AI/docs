...
![The "Add to Block List" dialog over the Block List screen at Settings → General → Block List, showing the single Phone Number field and the Add to List button](/screenshots/voice-do-not-call-list.png)
