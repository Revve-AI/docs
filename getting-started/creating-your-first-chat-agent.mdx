...
<Tip>
You can always come back and edit your agent. Changes are saved as a draft and only go live when you publish a new version. See [Publishing & Versioning](/getting-started/publishing-and-versioning) for details.
</Tip>
...
- [Understanding Engine Types](/getting-started/understanding-engine-types) — Learn when to use Single Prompt vs. Conversational Flow.
- [Publishing & Versioning](/getting-started/publishing-and-versioning) — How drafts, publishing, and version history work.
