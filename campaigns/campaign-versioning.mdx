...
| Action button | **Publish** or **Submit for Review**, depending on your permission. If the draft has fallen behind the active version, publishing is blocked until you **Discard Draft** and re-edit — see above. |
