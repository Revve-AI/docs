...
- If you need to analyze conversation data outside of Revve, see [Exporting Conversations](/history-analytics/exporting-conversations) for CSV export options.
