...
- Use daily reports alongside the [Analytics Dashboard](/history-analytics/analytics-dashboard) for a complete picture -- the report gives you a quick daily snapshot, while the dashboard lets you explore trends over longer time periods.
