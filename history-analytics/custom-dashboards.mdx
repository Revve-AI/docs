...
description: "Create call dashboards with configurable charts, metrics, filters, layouts, and a controlled publish workflow."
---

Use **Analytics > Dashboards** to create reports from your team's call data. Choose metrics, apply filters, and arrange charts for your team.
...
| Setting | Options |
|---------|---------|
| **Graph Type** | Line, Column, Bar, Donut, or Number. |
| **Metric** | One metric from the workspace's available catalog. |
| **Aggregation** | Count, sum, average, rate, or 95th percentile, where supported by the metric. |
...
| **Date range** | Inherit the dashboard range, select a preset, or set a custom range for this chart. |
| **Time interval** | Automatic, hour, day, week, or month for Line, Column, and Bar charts. |
