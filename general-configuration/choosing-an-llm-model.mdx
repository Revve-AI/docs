...
- [Configuring Agent Identity](/general-configuration/configuring-agent-identity) -- set the name, description, and role that guide the model.
- [Language and Tone Settings](/general-configuration/language-and-tone-settings) -- configure language and communication style that work with the model.
