...
![The Tickets page with the search box, status, assignee, and date-range filters above the ticket table, and Export CSV at the bottom](/screenshots/tickets-list.png)
...
![The Ticket Types settings page with the Add Ticket Type button](/screenshots/settings-ticket-types.png) Each type's card shows its name, ID-prefix chip, description, default-status badge, and Active/Inactive and Can Reopen/No Reopen indicators; the row menu offers **Edit**, **Configure Fields**, and **Delete**.
