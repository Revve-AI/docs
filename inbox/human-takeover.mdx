...
Human takeover is the process of transferring a conversation from an AI Chat Agent to a human team member. This happens when a visitor needs personal attention, the conversation requires judgment the AI cannot provide, or the AI agent is configured to hand off at certain points in the flow. For the voice equivalent — a voice agent handing a live call to your team — see [Transferring Calls to a Human](/voice-agents/call-transfer).
