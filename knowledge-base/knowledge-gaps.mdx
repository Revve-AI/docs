...
- [Adding Web Pages and Documents](/knowledge-base/adding-web-pages-and-documents) -- Add the content needed to fill knowledge gaps.
- [Managing FAQs](/knowledge-base/managing-faqs) -- Create FAQ entries for common gap questions.
- [Knowledge Base Settings](/knowledge-base/knowledge-base-settings) -- Fine-tune how your agent searches for answers.
