...
- **Review knowledge gaps.** If your agent is still missing questions after enabling Advanced Search, check the [Knowledge Gaps](/knowledge-base/knowledge-gaps) page. The issue is likely missing content rather than a search configuration problem.

## Related Topics

- [Knowledge Base Overview](/knowledge-base/knowledge-base-overview) -- Understand the full knowledge base system.
- [Adding Web Pages and Documents](/knowledge-base/adding-web-pages-and-documents) -- Add content for your agent to search.
- [Managing FAQs](/knowledge-base/managing-faqs) -- Create precise question-and-answer pairs.
