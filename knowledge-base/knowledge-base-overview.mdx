...
- [Adding Web Pages and Documents](/knowledge-base/adding-web-pages-and-documents) -- Learn how to upload files and add web content.
- [Managing FAQs](/knowledge-base/managing-faqs) -- Create and organize question-and-answer pairs.
- [Knowledge Gaps](/knowledge-base/knowledge-gaps) -- Find and fill gaps in your agent's knowledge.
- [Knowledge Base Settings](/knowledge-base/knowledge-base-settings) -- Configure search behavior for your agent.
