...
- [Flow Node Features](/conversational-flow/flow-node-features) -- Learn about per-node settings like contact collection, testimonials, human escalation, and tool assignment.
- [Creating and Connecting Nodes](/conversational-flow/creating-and-connecting-nodes) -- Review how to add nodes and define transitions.
