...
- [Creating and Connecting Nodes](/conversational-flow/creating-and-connecting-nodes) -- Learn how to add nodes and define transitions.
- [Global Nodes and Prompts](/conversational-flow/global-nodes-and-prompts) -- Understand nodes that can be reached from anywhere in the flow.
- [Flow Node Features](/conversational-flow/flow-node-features) -- Explore per-node settings like contact collection, meeting scheduling, and more.
